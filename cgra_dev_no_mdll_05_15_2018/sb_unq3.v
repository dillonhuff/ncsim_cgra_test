...
//
// pe_output_count (_GENESIS2_INHERITANCE_PRIORITY_) = 3
//
...
read_data
  ...
  always @(posedge clk or posedge reset) begin
    if (reset==1'b1) begin
      ...
      config_sb <= 96'h1000000000000000;
  ...
  always @(posedge clk or posedge reset) begin
    if (reset==1'b1) begin
      ...
      if (config_en==1'b1) begin
         case (config_addr[31:24])
           8'd3: config_ungate[31:0] <= config_data;
           default: ;
         endcase
      end
    end
  ...
  always @ (*) begin
    case (config_addr[31:24])    
         ...
         8'd3: read_data = config_ungate[31:0];
         8'd4 : read_data = out_0_0_id1;
         8'd5 : read_data = out_0_1_id1;
         8'd6 : read_data = out_0_2_id1;
         8'd7 : read_data = out_0_3_id1;
         8'd8 : read_data = out_0_4_id1;
         8'd9 : read_data = out_1_0_id1;
         8'd10 : read_data = out_1_1_id1;
         8'd11 : read_data = out_1_2_id1;
         8'd12 : read_data = out_1_3_id1;
         8'd13 : read_data = out_1_4_id1;
         8'd14 : read_data = out_2_0_id1;
         8'd15 : read_data = out_2_1_id1;
         8'd16 : read_data = out_2_2_id1;
         8'd17 : read_data = out_2_3_id1;
         8'd18 : read_data = out_2_4_id1;
         8'd19 : read_data = out_3_0_id1;
         8'd20 : read_data = out_3_1_id1;
         8'd21 : read_data = out_3_2_id1;
         8'd22 : read_data = out_3_3_id1;
         8'd23 : read_data = out_3_4_id1;
