...
//	
//
//  Source file: /horowitz/users/dhuff/CGRAGenerator/hardware/generator_z/memory_tile/memory_tile.vp
...
//  wire clk;
  ...
  always @(*) begin
    if(reset) begin
      config_en_sram[2] = 1'b0;
       ...
       if ((config_addr[15:0]==tile_id)&&(config_addr[23:16]==8'd7) && (config_read | config_write)) begin
  ...
  always @(*) begin
    if(reset) begin
      config_en_sram[3] = 1'b0;
       ...
       if ((config_addr[15:0]==tile_id)&&(config_addr[23:16]==8'd8) && (config_read | config_write)) begin
  ...
  always @(*) begin
    if (reset) begin
       ...
       if ((config_addr[15:0]==tile_id)&&(config_addr[23:16]==8'd15)&&config_write) begin
  ...
  always @(*) begin
    if (reset) begin
       ...
       if ((config_addr[15:0]==tile_id)&&(config_addr[23:16]==8'd16)&&config_write) begin
...
wire [31:0] read_data_sb_1_BUS1;    
  ...
  (
    ...
    .read_data(read_data_sb_1_BUS1)
  );
wire [31:0] read_data_sb_1_BUS16;    
  ...
  (
    ...
    .read_data(read_data_sb_1_BUS16)
  );
   ...
   always @(*) begin
           if (config_read && (config_addr[15:0]==tile_id)) begin
                   case (config_addr[23:16])
                        ...
                        'd1 : read_data = read_data_sb_1_BUS1;
                        'd10 : read_data = gout_sel;
                        'd11 : read_data = read_data_cb_wdata;
                        'd12 : read_data = read_data_cb_addr;
                        'd13 : read_data = read_data_cb_ren;
                        'd14 : read_data = read_data_cb_wen;
                        'd15 : read_data = read_data_cb_flush;
                        'd16 : read_data = read_data_cb_cg_en;
                        'd2 : read_data = read_data_sb_0_BUS16;
                        'd3 : read_data = read_data_sb_1_BUS16;
                        'd4 : read_data = read_data_mem;
                        'd5 : read_data = read_data_sram;
                        'd6 : read_data = read_data_sram;
                        'd7 : read_data = read_data_sram;
                        'd8 : read_data = read_data_sram;
                        'd9 : read_data = read_data_linebuf;
