...
//	
//
//  Source file: /horowitz/users/dhuff/CGRAGenerator/hardware/generator_z/pe_new/pe/rtl/test_pe.svp
...
//
// use_relu (_GENESIS2_DECLARATION_PRIORITY_) = 0
//
...
//
// use_acc (_GENESIS2_DECLARATION_PRIORITY_) = 1
//
// en_ovfl (_GENESIS2_DECLARATION_PRIORITY_) = 1
//
// en_debug (_GENESIS2_INHERITANCE_PRIORITY_) = 1
//
// lut_inps (_GENESIS2_INHERITANCE_PRIORITY_) = 3
//
// reg_cnt (_GENESIS2_DECLARATION_PRIORITY_) = 1
//
...
logic  [DataWidth-1:0]        op_a_reg;
logic  [DataWidth-1:0]        op_b;
logic  [DataWidth-1:0]        op_b_reg;
logic                         op_d_p;
logic                         op_d_p_reg;
logic                         op_e_p;
logic                         op_e_p_reg;
...
assign en_acc = op_code[9:9];
  ...
  assign op_b_val = (cfg_en && (cfg_a == 8'hF1)) ?
                    cfg_d[DataWidth-1:0] :
                    ((en_acc & op_d_p) ? {DataWidth{1'b0}}: comp_res);



test_opt_reg_file #(.DataWidth(DataWidth)) test_opt_reg_file
(
  .clk        (clk),
  .clk_en     (clk_en),
  .rst_n      (rst_n),
